...
This is a WAI application wrapper so that this server can, say, be embedded in a Servant app.

> waiApp :: MVar ServerState -> Wai.Application
> waiApp state = WaiSock.websocketsOr WS.defaultConnectionOptions (application state) errorApp
>   where
